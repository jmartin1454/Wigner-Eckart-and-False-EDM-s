...
operator $(xp_x+yp_y)$ in quantum mechanics.  For a particle in a
spherically symmetric potential, the stationary states may be written
as eigenstates of the angular momentum operators
\begin{equation}
...
The Wigner-Eckart theorem relates matrix elements involving these
states to Clebsch-Gordan coefficients \cite{bib:sakurai}.  Applied to two
states $|n\ell m\rangle$ and $|n\ell m\rangle$, it would read
\begin{equation}
