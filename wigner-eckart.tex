...
\begin{equation}
  ...
  \langle xB_x+yB_y\rangle=\sum_{\ell=2,4,6,...}^\infty A_{\ell
    0}\left\langle\left(x\frac{\partial}{\partial
    x}+y\frac{\partial}{\partial y}\right)r^\ell Y_{\ell
    0}\right\rangle
\end{equation}
...
zeroed, and that for this selection the $\ell=6$ term can be reduced compared to the typical cell geometry used for the ILL nEDM experiment.
