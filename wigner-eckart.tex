...
\begin{equation}
\frac{H^{4}}{16}-\frac{5R^2H^2}{12}+\frac{5R^4}{16}=-\frac{23}{48}R^4
\end{equation}

For ILL/PSI nEDM experiment, the cell dimensions are $R=0.235$~m and
$H=0.12$~m, and so Eq.~(\ref{eq:h}) is clearly not obeyed.

Using the ILL/PSI geometry, the $\ell=4$ term is
\begin{equation}
\frac{H^{2}}{4}-\frac{R^2}{2}=\num{3.3e-4}
\end{equation}
